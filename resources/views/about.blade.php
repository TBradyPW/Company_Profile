    ...
    <main class="about-page style-5">
        <!-- ====== start about ====== -->
            <header class="about-page-sec style-5">
                    ...
                    <img src="{{ asset('assets/Main/img/header/hand_megaphone.png') }}" alt="" class="hand-mega slide_up_down">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="#" class="img">
                                        <img src="{{ asset('assets/Main/img/logos/12.png') }}" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="content">
                    <div class="culture-slider position-relative pb-80 style-5">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="{{ asset('assets/Main/img/Main/cl1.png') }}" class="culture-card d-block"
                                        data-fancybox="gallery">
                                        <img src="{{ asset('assets/Main/img/Main/cl1.png') }}" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('assets/Main/img/Main/cl2.png') }}" class="culture-card d-block"
                                        data-fancybox="gallery">
                                        <img src="{{ asset('assets/Main/img/Main/cl2.png') }}" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{ asset('assets/Main/img/Main/cl3.png') }}" class="culture-card d-block"
                                        data-fancybox="gallery">
                                        <img src="{{ asset('assets/Main/img/Main/cl3.png') }}" alt="">
                                        <span class="overlay"></span>
                                    </a>
                                </div>
                                <div class="swiper-slide">
