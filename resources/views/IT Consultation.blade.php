                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="blog_box">
                                        ...
                                        <div class="img">
                                            <img src="{{ asset('assets/Main/img/blog/1.jpg') }}" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <div class="swiper-slide">
                                    <div class="blog_box">
                                        ...
                                        <div class="img">
                                            <img src="{{ asset('assets/Main/img/blog/2.jpg') }}" alt="">
                                        </div>
                                        <div class="info">
                                            ...
                                            <div class="auther">
                                                <span>
                                                    <img class="auther-img"
                                                        src="{{ asset('assets/Main/img/testimonials/user2.jpg') }}"
                                                        alt="">
                                ...
                                <div class="swiper-slide">
                                    <div class="blog_box">
                                        ...
                                        <div class="img">
                                            <img src="{{ asset('assets/Main/img/blog/3.jpg') }}" alt="">
                                        </div>
                                        <div class="info">
                                            ...
                                            <div class="auther">
                                                <span>
                                                    <img class="auther-img"
                                                        src="{{ asset('assets/Main/img/testimonials/user3.jpg') }}"
                                                        alt="">
                                                    <small><a href="#">By Admin</a></small>
                                                </span>
                                                <span>
                                ...
                                <div class="swiper-slide">
                                    <div class="blog_box">
                                        ...
                                        <div class="img">
                                            <img src="{{ asset('assets/Main/img/blog/4.jpg') }}" alt="">
                                        </div>
                                        <div class="info">
