    ...
    <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/1.png') }}" alt="">
                            </a>
                        </div>
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/2.png') }}" alt="">
                            </a>
                        </div>
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/3.png') }}" alt="">
                            </a>
                        </div>
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/4.png') }}" alt="">
                            </a>
                        </div>
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/5.png') }}" alt="">
                            </a>
                        </div>
                        <div class="col-6 col-lg-2">
                            <a href="#" class="img d-block">
                                <img src="{{ asset('assets/Main/img/logos/6.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="features-card">
                        <div class="icon img-contain">
                            <img src="{{ asset('assets/Main/img/icons/fe1.png') }}" alt="">
                        </div>
                        <h6>Notes Powerful <br> and Security</h6>
                    </div>
                    <div class="features-card">
                        <div class="icon img-contain">
                            <img src="{{ asset('assets/Main/img/icons/fe2.png') }}" alt="">
                        </div>
                        <h6>Easy Sort, Classify <br> and Search</h6>
                    </div>
                    <div class="features-card">
                        <div class="icon img-contain">
                            <img src="{{ asset('assets/Main/img/icons/fe3.png') }}" alt="">
                            <span
                    ...
                    <div class="features-card">
                        <div class="icon img-contain">
                            <img src="{{ asset('assets/Main/img/icons/fe4.png') }}" alt="">
                        </div>
                        <h6>Quick Note In <br> Everywhere</h6>
                    </div>
                    <div class="features-card">
                        <div class="icon img-contain">
                            <img src="{{ asset('assets/Main/img/icons/fe5.png') }}" alt="">
                        </div>
                        <h6>Write and Draw <br> on Ipad</h6>
                    </div>
                </div>
            </div>
            <img src="{{ asset('assets/Main/img/feat_circle.png') }}" alt="" class="img-circle">
        </section>
        <!-- ====== end features ====== -->
        ...
        <section class="about section-padding style-4">
            <div class="content frs-content" id="about" data-scroll-index="2">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <div class="img mb-30 mb-lg-0">
                                <img src="{{ asset('assets/Main/img/about/ipad.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="info">
                                ...
                                <p class="text mb-40">
                                    Stay focused and productive with a clean and clutter-free note <br> space. The flexible
                                    ways to organize your notes: hashtags, nested notebooks, pinning notes to the top of the
                                    note list, etc
                                </p>
                                <ul>
                                    <li class="d-flex align-items-center mb-3">
                                        <small
                                            class="icon-30 bg-gray rounded-circle color-blue5 d-inline-flex align-items-center justify-content-center me-3">
                                ...
                                <a href="page-contact-5.html"
                                    class=" btn sm-butn butn-gard border-0 text-white rounded-pill bg-blue5 fw-bold text-white mt-50">
                ...
                <img src="{{ asset('assets/Main/img/about/about_s4_lines.png') }}" alt="" class="lines">
                <img src="{{ asset('assets/Main/img/about/about_s4_bubble.png') }}" alt="" class="bubble">
            </div>
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-5 order-2 order-lg-0">
                            <div class="info">
                                ...
                                <a href="https://chrome.google.com/webstore/category/extensions"
                                    ...
                                    <div class="icon img-contain">
                                        <img src="{{ asset('assets/Main/img/icons/chrome_icon.png') }}" alt="">
                                    </div>
                                    <div class="inf">
                        ...
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="img mb-30 mb-lg-0">
                                <img src="{{ asset('assets/Main/img/about/2mobiles.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <img src="{{ asset('assets/Main/img/about/about_s4_bubble2.png') }}" alt="" class="bubble2">
            </div>
            <div class="content trd-content">
                <div class="container">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <div class="img mb-30 mb-lg-0">
                                <img src="{{ asset('assets/Main/img/about/about_s4_img3.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="info">
                                ...
                                <p class="text mb-40">
                                    Apply Notero’s elegant themes to your taste. Dark themes work excellently for those who
                                    prefer distraction-free mode.
                                </p>
                                <ul>
                                    <li class="d-flex align-items-center op-4">
                                        <i class="bi bi-dot fs-2 me-2 lh-1 color-blue5"></i>
                                        <h6 class="fw-bold">Filtering notes using matched keywords</h6>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i class="bi bi-dot fs-2 me-2 lh-1 color-blue5"></i>
            ...
            <div class="integration pt-60" data-scroll-index="3">
                ...
                <div class="container">
                    <div class="content">
                        <div class="img">
                            <img src="{{ asset('assets/Main/img/about/intg1.png') }}" alt="" class="mt-30">
                        </div>
                        <div class="img">
                            <img src="{{ asset('assets/Main/img/about/intg5.png') }}" alt="" class="mt-60">
                        </div>
                        <div class="img">
                            <img src="{{ asset('assets/Main/img/about/intg4.png') }}" alt="" class="mt-20">
                        </div>
                        <div class="img">
                            <img src="{{ asset('assets/Main/img/about/intg3.png') }}" alt="" class="mt-80">
                        </div>
                        <div class="img">
                            <img src="{{ asset('assets/Main/img/about/intg2.png') }}" alt="">
                        </div>
                    </div>
                </div>
                <img src="{{ asset('assets/Main/img/about/intg_back.png') }}" alt="" class="intg-back">
            </div>
            <img src="{{ asset('assets/Main/img/about/about_s4_wave.png') }}" alt="" class="top-wave">
            <img src="{{ asset('assets/Main/img/about/about_s4_wave.png') }}" alt="" class="bottom-wave">
        </section>
        <!-- ====== end about ====== -->
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="img">
                                <img src="{{ asset('assets/Main/img/screenshots/1.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="img">
                                <img src="{{ asset('assets/Main/img/screenshots/2.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="img">
                                <img src="{{ asset('assets/Main/img/screenshots/3.jpg') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="img">
                                <img src="{{ asset('assets/Main/img/screenshots/4.png') }}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="img">
                                <img src="{{ asset('assets/Main/img/screenshots/5.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <img src="{{ asset('assets/Main/img/screenshots/hand.png') }}" alt="" class="mob-hand">
        </div>
        <!-- ====== end screenshots  ====== -->
                ...
                <div class="content">
                    <div class="toggle_switch d-flex align-items-center justify-content-center mb-40">
                        <div class="form-check form-switch p-0">
                            <label class="form-check-label" for="flexSwitchCheckDefault"><small>Billed
                                    monthly</small></label>
                            <input class="form-check-input float-none bg-blue5" type="checkbox"
                    ...
                    <div class="row gx-0">
                        <div class="col-lg-6">
                            <div class="price-card">
                                <div class="price-header pb-4">
                                    <h6> <img src="{{ asset('assets/Main/img/icons/price_s4_1.png') }}" alt=""
                                            class="icon"> basic
                                        Plan </h6>
                                ...
                                <div class="price-body py-4">
                                    <ul>
                                        <li class="d-flex align-items-center mb-3">
                                            <small
                                                class="icon-30 bg-blue5 rounded-circle text-white d-inline-flex align-items-center justify-content-center me-3 flex-shrink-0">
                        ...
                        <div class="col-lg-6">
                            <div class="price-card">
                                <div class="price-header pb-4">
                                    <h6> <img src="{{ asset('assets/Main/img/icons/price_s4_2.png') }}" alt=""
                                            class="icon">
                                        premium Plan </h6>
                                ...
                                <div class="price-body py-4">
                                    ...
                                    <a href="page-contact-5.html"
                                        class=" btn sm-butn butn-gard border-0 text-white rounded-pill bg-blue5 fw-bold text-white px-5 mt-50">
                                        <small>Register Now </small>
                                    </a>
                                </div>
                                <div class="off">
                                ...
                                <div class="col-lg-6">
                                    <div class="accordion-item border-bottom rounded-0">
                                        ...
                                        <div id="collapse11" class="accordion-collapse collapse rounded-0"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                we're able to attain <br> mutual understanding, gain customer trust to offer
                                                appropriate advice
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item border-bottom rounded-0 ">
                                        ...
                                        <div id="collapse12" class="accordion-collapse collapse show rounded-0"
                                            aria-labelledby="heading12" data-bs-parent="#accordionSt5">
                                            <div class="accordion-body">
                                                Through the collaboration with customers in discussing needs and demand,
                                                we're able to attain <br> mutual understanding, gain customer trust to offer
                                                appropriate advice
