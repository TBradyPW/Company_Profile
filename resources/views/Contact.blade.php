...
<!-- ====== start contact page ====== -->
    <section class="contact section-padding pt-50 style-6">
        <div class="container">
            ...
            <div class="text-center mb-100">
                <h2 class="ltspc-20 text-uppercase fs-1 lh-1 mb-50 mt-30 color-blue5">(+62) 812 2218 1823</h2>
                <h4 class="fw-normal mb-20 color-000">contact@hexagon.co.id</h4>
                <p class="fw-normal mb-10 color-000"> </p><p> Office 1 : </p> Gedung BITC lt.3, Jl. MHS Mintareja Sarjana Hukum, Baros, Kota Cimahi 40521 <br>
                    <br> <p> Office 2 : </p> Jl. Terusan Jakarta No. 175A, Antapani, bandung 40287 <br>
                    <br> <p> Marketing Office : </p> Komplek Pondok Indah Plaza 1 Blok UA No. 32 Lt. II, Jaksel, DKI Jakarta <br>
                    <br> <p> Studio : </p>Jl. Abdul Halim No.128, Cimahi Tengah, Kota Cimahi 40522
                <p></p>
            </div>
            <div class="content">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <form action="https://smartinnovates.com/items/iteck/html/contact.php" class="form" method="post">
    ...
    <!-- ====== start contact page ====== -->
    <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3539.055827037373!2d107.55195482056057!3d-6.890996429885855!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e5d9351515f9%3A0xe262b702be99628a!2sHexagon%20Inc.!5e0!3m2!1sen!2sid!4v1664252136539!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <!-- ====== start contact page ====== -->
</main>
@endsection