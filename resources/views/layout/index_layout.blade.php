...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/Index/img/fav-hexagon.png') }}" title="Favicon" sizes="16x16" />

    <!-- ====== bootstrap icons cdn ====== -->
    <link rel="stylesheet" href="cdn.jsdelivr.net/npm/bootstrap-icons%401.7.2/font/bootstrap-icons.html">
    ...
    <link rel="stylesheet" href="{{ asset('assets/Index/css/lib/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/Index/css/lib/animate.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/Index/css/lib/jquery.fancybox.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/Index/css/lib/lity.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/Index/css/lib/swiper.min.css') }}" />
    <!-- ====== global style ====== -->
...
<body>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="img pe-lg-5">
                            <img src="{{ asset('assets/Index/img/choose_us/circles.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="info">
                            ...
                            <ul>
                                <li class="d-flex mb-30">
                                    <div class="icon me-4 flex-shrink-0">
                                        <img src="{{ asset('assets/Index/img/icons/ch1.png') }}" alt="">
                                    </div>
                                    <div class="inf">
                                ...
                                <li class="d-flex mb-30">
                                    <div class="icon me-4 flex-shrink-0">
                                        <img src="{{ asset('assets/Index/img/icons/ch2.png') }}" alt="">
                                    </div>
                                    <div class="inf">
                                ...
                                <li class="d-flex">
                                    <div class="icon me-4 flex-shrink-0">
                                        <img src="{{ asset('assets/Index/img/icons/ch3.png') }}" alt="">
                                    </div>
                                    <div class="inf">
                            ...
                            <a href="contact_5.html" class="btn sm-butn border text-white radius-9 mt-70 hover-darkBlue">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="foot_links text-uppercase text-center small">
                        <a href="index.html" class="mx-4">
                            Home
                        </a>
                        <a href="about.html" class="mx-4">
                            about
                        </a>
                        <a href="service.html" class="mx-4">
                            services
                        </a>
                        <a href="projects.html" class="mx-4">
                            portfolio
                        </a>
                        <a href="posts.html" class="mx-4">
                            news
                        </a>
                    </div>
                </div>
    ...
    <!-- ====== request ====== -->
    <script src="{{ asset('assets/Index/js/lib/jquery-3.0.0.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/jquery-migrate-3.0.0.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/wow.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/jquery.fancybox.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/lity.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/swiper.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('assets/Index/js/lib/jquery.counterup.js') }}"></script>
    <!-- <script src="{{ asset('assets/Index/js/lib/pace.js') }}"></script> -->
